...
var lt = defineComponent({
  ...
  setup(t, { emit: e }) {
    ...
    return (u, B) => (openBlock(), createBlock(unref(Pi), {
      open: unref(d),
      modal: unref(y),
      "onUpdate:open": C
    }, {
...
var ct = defineComponent({
  ...
  setup(t) {
    ...
    return ($, g) => (openBlock(), createBlock(unref(Zi), {
      ref_key: "overlayRef",
      ref: e,
...
var dt = defineComponent({
  ...
  setup(t) {
    ...
    return watch(
      ...
      { immediate: true }
    ), (l, c) => (openBlock(), createBlock(unref(Yi), {
      ref_key: "drawerRef",
      ref: w,
      "vaul-drawer": "",
      "vaul-drawer-visible": unref(s) ? "true" : "false",
