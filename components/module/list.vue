    ...
    <Tabs default-value="pending" class="w-full">
        ...
        <TabsContent class="w-full" value="pending">
            <div
                ...
                class="p-16 text-center space-y-2"
            >
            ...
            <div class="flex flex-col gap-5 mt-3">
                <ModuleItem
                    ...
                    :numberOfSections="activeModule.number_of_sections"
                    status="active"
                    :activeSection="props.activeSection"
                    :totalDuration="activeModule.duration"
                />
                <ModuleItem
                    v-for="module in pending"
                    :key="module.id"
                    :module="module"
                    :id="module.id"
                    :index="module.index"
                    :title="module.title"
                    :numberOfSections="module.number_of_sections"
                    status="pending"
